...
"""
Dan is an investor in a stock called AAAPL. 
He purchased 10 shares for $15 each. 
Now, each of those shares is worth $17. 
Dan would like to know how much money he has made on the stock.
"""

def money_made(num_shares, purchase_share_price, current_share_prive):
    """
    ...
    """
    return num_shares * (current_share_prive - purchase_share_price)
